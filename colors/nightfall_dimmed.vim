...
let g:colors_name = 'nightfall_dimmed'
...
if s:configuration.transparent_background >= 1
  call nightfall_dimmed#highlight('Normal', s:palette.fg, s:palette.none)
  call nightfall_dimmed#highlight('NormalNC', s:palette.fg, s:palette.none)
  call nightfall_dimmed#highlight('Terminal', s:palette.fg, s:palette.none)
  if s:configuration.show_eob
    call nightfall_dimmed#highlight('EndOfBuffer', s:palette.bg4, s:palette.none)
  else
    call nightfall_dimmed#highlight('EndOfBuffer', s:palette.bg0, s:palette.none)
  endif
  if s:configuration.ui_contrast ==# 'low'
    call nightfall_dimmed#highlight('FoldColumn', s:palette.bg5, s:palette.none)
  else
    call nightfall_dimmed#highlight('FoldColumn', s:palette.grey0, s:palette.none)
  endif
  call nightfall_dimmed#highlight('Folded', s:palette.grey1, s:palette.none)
  call nightfall_dimmed#highlight('SignColumn', s:palette.fg, s:palette.none)
  call nightfall_dimmed#highlight('ToolbarLine', s:palette.fg, s:palette.none)
else
  call nightfall_dimmed#highlight('Normal', s:palette.fg, s:palette.bg0)
  if s:configuration.dim_inactive_windows
    call nightfall_dimmed#highlight('NormalNC', s:palette.fg, s:palette.bg_dim)
  else
    call nightfall_dimmed#highlight('NormalNC', s:palette.fg, s:palette.bg0)
  endif
  call nightfall_dimmed#highlight('Terminal', s:palette.fg, s:palette.bg0)
  if s:configuration.show_eob
    call nightfall_dimmed#highlight('EndOfBuffer', s:palette.bg4, s:palette.none)
  else
    call nightfall_dimmed#highlight('EndOfBuffer', s:palette.bg0, s:palette.none)
  endif
  call nightfall_dimmed#highlight('Folded', s:palette.grey1, s:palette.bg1)
  call nightfall_dimmed#highlight('ToolbarLine', s:palette.fg, s:palette.bg2)
  if s:configuration.sign_column_background ==# 'grey'
    call nightfall_dimmed#highlight('SignColumn', s:palette.fg, s:palette.bg1)
    call nightfall_dimmed#highlight('FoldColumn', s:palette.grey2, s:palette.bg1)
  else
    call nightfall_dimmed#highlight('SignColumn', s:palette.fg, s:palette.none)
    if s:configuration.ui_contrast ==# 'low'
      call nightfall_dimmed#highlight('FoldColumn', s:palette.bg5, s:palette.none)
...
call nightfall_dimmed#highlight('IncSearch', s:palette.bg0, s:palette.red)
call nightfall_dimmed#highlight('Search', s:palette.bg0, s:palette.green)
highlight! link CurSearch IncSearch
call nightfall_dimmed#highlight('ColorColumn', s:palette.none, s:palette.bg1)
if s:configuration.ui_contrast ==# 'low'
  call nightfall_dimmed#highlight('Conceal', s:palette.bg5, s:palette.none)
else
  call nightfall_dimmed#highlight('Conceal', s:palette.grey0, s:palette.none)
endif
if s:configuration.cursor ==# 'auto'
  call nightfall_dimmed#highlight('Cursor', s:palette.none, s:palette.none, 'reverse')
else
  call nightfall_dimmed#highlight('Cursor', s:palette.bg0, s:palette[s:configuration.cursor])
endif
...
if &diff
  call nightfall_dimmed#highlight('CursorLine', s:palette.none, s:palette.none, 'underline')
  call nightfall_dimmed#highlight('CursorColumn', s:palette.none, s:palette.none, 'bold')
else
  call nightfall_dimmed#highlight('CursorLine', s:palette.none, s:palette.bg1)
  call nightfall_dimmed#highlight('CursorColumn', s:palette.none, s:palette.bg1)
endif
if s:configuration.ui_contrast ==# 'low'
  call nightfall_dimmed#highlight('LineNr', s:palette.bg5, s:palette.none)
  if &diff
    call nightfall_dimmed#highlight('CursorLineNr', s:palette.grey1, s:palette.none, 'underline')
  elseif (&relativenumber == 1 && &cursorline == 0) || s:configuration.sign_column_background ==# 'none'
    call nightfall_dimmed#highlight('CursorLineNr', s:palette.grey1, s:palette.none)
  else
    call nightfall_dimmed#highlight('CursorLineNr', s:palette.grey1, s:palette.bg1)
  endif
else
  call nightfall_dimmed#highlight('LineNr', s:palette.grey0, s:palette.none)
  if &diff
    call nightfall_dimmed#highlight('CursorLineNr', s:palette.grey2, s:palette.none, 'underline')
  elseif (&relativenumber == 1 && &cursorline == 0) || s:configuration.sign_column_background ==# 'none'
    call nightfall_dimmed#highlight('CursorLineNr', s:palette.grey2, s:palette.none)
  else
    call nightfall_dimmed#highlight('CursorLineNr', s:palette.grey2, s:palette.bg1)
  endif
endif
call nightfall_dimmed#highlight('DiffAdd', s:palette.none, s:palette.bg_green)
call nightfall_dimmed#highlight('DiffChange', s:palette.none, s:palette.bg_blue)
call nightfall_dimmed#highlight('DiffDelete', s:palette.none, s:palette.bg_red)
call nightfall_dimmed#highlight('DiffText', s:palette.bg0, s:palette.blue)
call nightfall_dimmed#highlight('Directory', s:palette.green, s:palette.none)
call nightfall_dimmed#highlight('ErrorMsg', s:palette.red, s:palette.none, 'bold,underline')
call nightfall_dimmed#highlight('WarningMsg', s:palette.yellow, s:palette.none, 'bold')
call nightfall_dimmed#highlight('ModeMsg', s:palette.fg, s:palette.none, 'bold')
call nightfall_dimmed#highlight('MoreMsg', s:palette.yellow, s:palette.none, 'bold')
call nightfall_dimmed#highlight('MatchParen', s:palette.none, s:palette.bg4)
call nightfall_dimmed#highlight('NonText', s:palette.bg4, s:palette.none)
call nightfall_dimmed#highlight('Whitespace', s:palette.bg4, s:palette.none)
call nightfall_dimmed#highlight('SpecialKey', s:palette.bg3, s:palette.none)
call nightfall_dimmed#highlight('Pmenu', s:palette.fg, s:palette.bg2)
call nightfall_dimmed#highlight('PmenuSbar', s:palette.none, s:palette.bg2)
call nightfall_dimmed#highlight('PmenuSel', s:palette.bg0, s:palette.statusline1)
call nightfall_dimmed#highlight('PmenuKind', s:palette.green, s:palette.bg2)
call nightfall_dimmed#highlight('PmenuExtra', s:palette.grey2, s:palette.bg2)
highlight! link WildMenu PmenuSel
call nightfall_dimmed#highlight('PmenuThumb', s:palette.none, s:palette.grey0)
if s:configuration.float_style ==# 'dim'
  call nightfall_dimmed#highlight('NormalFloat', s:palette.fg, s:palette.bg_dim)
  call nightfall_dimmed#highlight('FloatBorder', s:palette.grey1, s:palette.bg_dim)
  call nightfall_dimmed#highlight('FloatTitle', s:palette.fg, s:palette.bg_dim, 'bold')
else
  call nightfall_dimmed#highlight('NormalFloat', s:palette.fg, s:palette.bg2)
  call nightfall_dimmed#highlight('FloatBorder', s:palette.grey1, s:palette.bg2)
  call nightfall_dimmed#highlight('FloatTitle', s:palette.fg, s:palette.bg2, 'bold')
endif
call nightfall_dimmed#highlight('Question', s:palette.yellow, s:palette.none)
if s:configuration.spell_foreground ==# 'none'
  call nightfall_dimmed#highlight('SpellBad', s:palette.none, s:palette.none, 'undercurl', s:palette.red)
  call nightfall_dimmed#highlight('SpellCap', s:palette.none, s:palette.none, 'undercurl', s:palette.blue)
  call nightfall_dimmed#highlight('SpellLocal', s:palette.none, s:palette.none, 'undercurl', s:palette.aqua)
  call nightfall_dimmed#highlight('SpellRare', s:palette.none, s:palette.none, 'undercurl', s:palette.purple)
else
  call nightfall_dimmed#highlight('SpellBad', s:palette.red, s:palette.none, 'undercurl', s:palette.red)
  call nightfall_dimmed#highlight('SpellCap', s:palette.blue, s:palette.none, 'undercurl', s:palette.blue)
  call nightfall_dimmed#highlight('SpellLocal', s:palette.aqua, s:palette.none, 'undercurl', s:palette.aqua)
  call nightfall_dimmed#highlight('SpellRare', s:palette.purple, s:palette.none, 'undercurl', s:palette.purple)
endif
if s:configuration.transparent_background == 2
  call nightfall_dimmed#highlight('StatusLine', s:palette.grey1, s:palette.none)
  call nightfall_dimmed#highlight('StatusLineTerm', s:palette.grey1, s:palette.none)
  call nightfall_dimmed#highlight('StatusLineNC', s:palette.grey0, s:palette.none)
  call nightfall_dimmed#highlight('StatusLineTermNC', s:palette.grey0, s:palette.none)
  call nightfall_dimmed#highlight('TabLine', s:palette.grey2, s:palette.bg3)
  call nightfall_dimmed#highlight('TabLineFill', s:palette.grey1, s:palette.none)
  call nightfall_dimmed#highlight('TabLineSel', s:palette.bg0, s:palette.statusline1)
  if has('nvim')
    call nightfall_dimmed#highlight('WinBar', s:palette.grey1, s:palette.none, 'bold')
    call nightfall_dimmed#highlight('WinBarNC', s:palette.grey0, s:palette.none)
  endif
else
  call nightfall_dimmed#highlight('StatusLine', s:palette.grey1, s:palette.bg2)
  call nightfall_dimmed#highlight('StatusLineTerm', s:palette.grey1, s:palette.bg1)
  call nightfall_dimmed#highlight('StatusLineNC', s:palette.grey1, s:palette.bg1)
  call nightfall_dimmed#highlight('StatusLineTermNC', s:palette.grey1, s:palette.bg0)
  call nightfall_dimmed#highlight('TabLine', s:palette.grey2, s:palette.bg3)
  call nightfall_dimmed#highlight('TabLineFill', s:palette.grey1, s:palette.bg1)
  call nightfall_dimmed#highlight('TabLineSel', s:palette.bg0, s:palette.statusline1)
  if has('nvim')
    call nightfall_dimmed#highlight('WinBar', s:palette.grey1, s:palette.bg2, 'bold')
    call nightfall_dimmed#highlight('WinBarNC', s:palette.grey1, s:palette.bg1)
  endif
endif
if s:configuration.dim_inactive_windows
  call nightfall_dimmed#highlight('VertSplit', s:palette.bg4, s:palette.bg_dim)
else
  call nightfall_dimmed#highlight('VertSplit', s:palette.bg4, s:palette.none)
endif
highlight! link WinSeparator VertSplit
call nightfall_dimmed#highlight('Visual', s:palette.none, s:palette.bg_visual)
call nightfall_dimmed#highlight('VisualNOS', s:palette.none, s:palette.bg_visual)
call nightfall_dimmed#highlight('QuickFixLine', s:palette.purple, s:palette.none, 'bold')
call nightfall_dimmed#highlight('Debug', s:palette.orange, s:palette.none)
call nightfall_dimmed#highlight('debugPC', s:palette.bg0, s:palette.green)
call nightfall_dimmed#highlight('debugBreakpoint', s:palette.bg0, s:palette.red)
call nightfall_dimmed#highlight('ToolbarButton', s:palette.bg0, s:palette.green)
if has('nvim')
  call nightfall_dimmed#highlight('Substitute', s:palette.bg0, s:palette.yellow)
  if s:configuration.diagnostic_text_highlight
    call nightfall_dimmed#highlight('DiagnosticError', s:palette.red, s:palette.bg_red)
    call nightfall_dimmed#highlight('DiagnosticUnderlineError', s:palette.none, s:palette.bg_red, 'undercurl', s:palette.red)
    call nightfall_dimmed#highlight('DiagnosticWarn', s:palette.yellow, s:palette.bg_yellow)
    call nightfall_dimmed#highlight('DiagnosticUnderlineWarn', s:palette.none, s:palette.bg_yellow, 'undercurl', s:palette.yellow)
    call nightfall_dimmed#highlight('DiagnosticInfo', s:palette.blue, s:palette.bg_blue)
    call nightfall_dimmed#highlight('DiagnosticUnderlineInfo', s:palette.none, s:palette.bg_blue, 'undercurl', s:palette.blue)
    call nightfall_dimmed#highlight('DiagnosticHint', s:palette.green, s:palette.bg_green)
    call nightfall_dimmed#highlight('DiagnosticUnderlineHint', s:palette.none, s:palette.bg_green, 'undercurl', s:palette.green)
  else
    call nightfall_dimmed#highlight('DiagnosticError', s:palette.red, s:palette.none)
    call nightfall_dimmed#highlight('DiagnosticUnderlineError', s:palette.none, s:palette.none, 'undercurl', s:palette.red)
    call nightfall_dimmed#highlight('DiagnosticWarn', s:palette.yellow, s:palette.none)
    call nightfall_dimmed#highlight('DiagnosticUnderlineWarn', s:palette.none, s:palette.none, 'undercurl', s:palette.yellow)
    call nightfall_dimmed#highlight('DiagnosticInfo', s:palette.blue, s:palette.none)
    call nightfall_dimmed#highlight('DiagnosticUnderlineInfo', s:palette.none, s:palette.none, 'undercurl', s:palette.blue)
...
" }}}
" Syntax: {{{
call nightfall_dimmed#highlight('Boolean', s:palette.purple, s:palette.none)
call nightfall_dimmed#highlight('Number', s:palette.purple, s:palette.none)
call nightfall_dimmed#highlight('Float', s:palette.purple, s:palette.none)
if s:configuration.enable_italic
  call nightfall_dimmed#highlight('PreProc', s:palette.purple, s:palette.none, 'italic')
  call nightfall_dimmed#highlight('PreCondit', s:palette.purple, s:palette.none, 'italic')
  call nightfall_dimmed#highlight('Include', s:palette.purple, s:palette.none, 'italic')
  call nightfall_dimmed#highlight('Define', s:palette.purple, s:palette.none, 'italic')
  call nightfall_dimmed#highlight('Conditional', s:palette.red, s:palette.none, 'italic')
  call nightfall_dimmed#highlight('Repeat', s:palette.red, s:palette.none, 'italic')
  call nightfall_dimmed#highlight('Keyword', s:palette.red, s:palette.none, 'italic')
  call nightfall_dimmed#highlight('Typedef', s:palette.red, s:palette.none, 'italic')
  call nightfall_dimmed#highlight('Exception', s:palette.red, s:palette.none, 'italic')
  call nightfall_dimmed#highlight('Statement', s:palette.red, s:palette.none, 'italic')
else
  call nightfall_dimmed#highlight('PreProc', s:palette.purple, s:palette.none)
  call nightfall_dimmed#highlight('PreCondit', s:palette.purple, s:palette.none)
  call nightfall_dimmed#highlight('Include', s:palette.purple, s:palette.none)
  call nightfall_dimmed#highlight('Define', s:palette.purple, s:palette.none)
  call nightfall_dimmed#highlight('Conditional', s:palette.red, s:palette.none)
  call nightfall_dimmed#highlight('Repeat', s:palette.red, s:palette.none)
  call nightfall_dimmed#highlight('Keyword', s:palette.red, s:palette.none)
  call nightfall_dimmed#highlight('Typedef', s:palette.red, s:palette.none)
  call nightfall_dimmed#highlight('Exception', s:palette.red, s:palette.none)
  call nightfall_dimmed#highlight('Statement', s:palette.red, s:palette.none)
endif
call nightfall_dimmed#highlight('Error', s:palette.red, s:palette.none)
call nightfall_dimmed#highlight('StorageClass', s:palette.orange, s:palette.none)
call nightfall_dimmed#highlight('Tag', s:palette.orange, s:palette.none)
call nightfall_dimmed#highlight('Label', s:palette.orange, s:palette.none)
call nightfall_dimmed#highlight('Structure', s:palette.orange, s:palette.none)
call nightfall_dimmed#highlight('Operator', s:palette.orange, s:palette.none)
call nightfall_dimmed#highlight('Title', s:palette.orange, s:palette.none, 'bold')
call nightfall_dimmed#highlight('Special', s:palette.yellow, s:palette.none)
call nightfall_dimmed#highlight('SpecialChar', s:palette.yellow, s:palette.none)
call nightfall_dimmed#highlight('Type', s:palette.yellow, s:palette.none)
call nightfall_dimmed#highlight('Function', s:palette.green, s:palette.none)
call nightfall_dimmed#highlight('String', s:palette.green, s:palette.none)
call nightfall_dimmed#highlight('Character', s:palette.green, s:palette.none)
call nightfall_dimmed#highlight('Constant', s:palette.aqua, s:palette.none)
call nightfall_dimmed#highlight('Macro', s:palette.aqua, s:palette.none)
call nightfall_dimmed#highlight('Identifier', s:palette.blue, s:palette.none)
call nightfall_dimmed#highlight('Todo', s:palette.bg0, s:palette.blue, 'bold')
if s:configuration.disable_italic_comment
  call nightfall_dimmed#highlight('Comment', s:palette.grey1, s:palette.none)
  call nightfall_dimmed#highlight('SpecialComment', s:palette.grey1, s:palette.none)
else
  call nightfall_dimmed#highlight('Comment', s:palette.grey1, s:palette.none, 'italic')
  call nightfall_dimmed#highlight('SpecialComment', s:palette.grey1, s:palette.none, 'italic')
endif
call nightfall_dimmed#highlight('Delimiter', s:palette.fg, s:palette.none)
call nightfall_dimmed#highlight('Ignore', s:palette.grey1, s:palette.none)
call nightfall_dimmed#highlight('Underlined', s:palette.none, s:palette.none, 'underline')
" }}}
" Predefined Highlight Groups: {{{
call nightfall_dimmed#highlight('Fg', s:palette.fg, s:palette.none)
call nightfall_dimmed#highlight('Grey', s:palette.grey1, s:palette.none)
call nightfall_dimmed#highlight('Red', s:palette.red, s:palette.none)
call nightfall_dimmed#highlight('Orange', s:palette.orange, s:palette.none)
call nightfall_dimmed#highlight('Yellow', s:palette.yellow, s:palette.none)
call nightfall_dimmed#highlight('Green', s:palette.green, s:palette.none)
call nightfall_dimmed#highlight('Aqua', s:palette.aqua, s:palette.none)
call nightfall_dimmed#highlight('Blue', s:palette.blue, s:palette.none)
call nightfall_dimmed#highlight('Purple', s:palette.purple, s:palette.none)
if s:configuration.enable_italic
  call nightfall_dimmed#highlight('RedItalic', s:palette.red, s:palette.none, 'italic')
  call nightfall_dimmed#highlight('OrangeItalic', s:palette.orange, s:palette.none, 'italic')
  call nightfall_dimmed#highlight('YellowItalic', s:palette.yellow, s:palette.none, 'italic')
  call nightfall_dimmed#highlight('GreenItalic', s:palette.green, s:palette.none, 'italic')
  call nightfall_dimmed#highlight('AquaItalic', s:palette.aqua, s:palette.none, 'italic')
  call nightfall_dimmed#highlight('BlueItalic', s:palette.blue, s:palette.none, 'italic')
  call nightfall_dimmed#highlight('PurpleItalic', s:palette.purple, s:palette.none, 'italic')
else
  call nightfall_dimmed#highlight('RedItalic', s:palette.red, s:palette.none)
  call nightfall_dimmed#highlight('OrangeItalic', s:palette.orange, s:palette.none)
  call nightfall_dimmed#highlight('YellowItalic', s:palette.yellow, s:palette.none)
  call nightfall_dimmed#highlight('GreenItalic', s:palette.green, s:palette.none)
  call nightfall_dimmed#highlight('AquaItalic', s:palette.aqua, s:palette.none)
  call nightfall_dimmed#highlight('BlueItalic', s:palette.blue, s:palette.none)
  call nightfall_dimmed#highlight('PurpleItalic', s:palette.purple, s:palette.none)
endif
if s:configuration.transparent_background || s:configuration.sign_column_background ==# 'none'
  call nightfall_dimmed#highlight('RedSign', s:palette.red, s:palette.none)
  call nightfall_dimmed#highlight('OrangeSign', s:palette.orange, s:palette.none)
  call nightfall_dimmed#highlight('YellowSign', s:palette.yellow, s:palette.none)
  call nightfall_dimmed#highlight('GreenSign', s:palette.green, s:palette.none)
  call nightfall_dimmed#highlight('AquaSign', s:palette.aqua, s:palette.none)
  call nightfall_dimmed#highlight('BlueSign', s:palette.blue, s:palette.none)
  call nightfall_dimmed#highlight('PurpleSign', s:palette.purple, s:palette.none)
else
  call nightfall_dimmed#highlight('RedSign', s:palette.red, s:palette.bg1)
  call nightfall_dimmed#highlight('OrangeSign', s:palette.orange, s:palette.bg1)
  call nightfall_dimmed#highlight('YellowSign', s:palette.yellow, s:palette.bg1)
  call nightfall_dimmed#highlight('GreenSign', s:palette.green, s:palette.bg1)
  call nightfall_dimmed#highlight('AquaSign', s:palette.aqua, s:palette.bg1)
  call nightfall_dimmed#highlight('BlueSign', s:palette.blue, s:palette.bg1)
  call nightfall_dimmed#highlight('PurpleSign', s:palette.purple, s:palette.bg1)
endif
if s:configuration.diagnostic_text_highlight
  call nightfall_dimmed#highlight('ErrorText', s:palette.none, s:palette.bg_red, 'undercurl', s:palette.red)
  call nightfall_dimmed#highlight('WarningText', s:palette.none, s:palette.bg_yellow, 'undercurl', s:palette.yellow)
  call nightfall_dimmed#highlight('InfoText', s:palette.none, s:palette.bg_blue, 'undercurl', s:palette.blue)
  call nightfall_dimmed#highlight('HintText', s:palette.none, s:palette.bg_green, 'undercurl', s:palette.green)
else
  call nightfall_dimmed#highlight('ErrorText', s:palette.none, s:palette.none, 'undercurl', s:palette.red)
  call nightfall_dimmed#highlight('WarningText', s:palette.none, s:palette.none, 'undercurl', s:palette.yellow)
  call nightfall_dimmed#highlight('InfoText', s:palette.none, s:palette.none, 'undercurl', s:palette.blue)
  call nightfall_dimmed#highlight('HintText', s:palette.none, s:palette.none, 'undercurl', s:palette.green)
endif
if s:configuration.diagnostic_line_highlight
  call nightfall_dimmed#highlight('ErrorLine', s:palette.none, s:palette.bg_red)
  call nightfall_dimmed#highlight('WarningLine', s:palette.none, s:palette.bg_yellow)
  call nightfall_dimmed#highlight('InfoLine', s:palette.none, s:palette.bg_blue)
  call nightfall_dimmed#highlight('HintLine', s:palette.none, s:palette.bg_green)
else
...
elseif s:configuration.diagnostic_virtual_text ==# 'colored'
  ...
  call nightfall_dimmed#highlight('VirtualTextWarning', s:palette.yellow, s:palette.bg_yellow)
  call nightfall_dimmed#highlight('VirtualTextError', s:palette.red, s:palette.bg_red)
  call nightfall_dimmed#highlight('VirtualTextInfo', s:palette.blue, s:palette.bg_blue)
  call nightfall_dimmed#highlight('VirtualTextHint', s:palette.green, s:palette.bg_green)
endif
call nightfall_dimmed#highlight('ErrorFloat', s:palette.red, s:palette.none)
call nightfall_dimmed#highlight('WarningFloat', s:palette.yellow, s:palette.none)
call nightfall_dimmed#highlight('InfoFloat', s:palette.blue, s:palette.none)
call nightfall_dimmed#highlight('HintFloat', s:palette.green, s:palette.none)
if &diff
  call nightfall_dimmed#highlight('CurrentWord', s:palette.bg0, s:palette.green)
elseif s:configuration.current_word ==# 'grey background'
  call nightfall_dimmed#highlight('CurrentWord', s:palette.none, s:palette.bg2)
else
...
let g:nightfall_dimmed_lsp_kind_color = [
      \ ["Array", "Aqua"],
      \ ["Boolean", "Aqua"],
      \ ["Class", "Red"],
      \ ["Class", "Yellow"],
...
call nightfall_dimmed#highlight('TSStrong', s:palette.none, s:palette.none, 'bold')
call nightfall_dimmed#highlight('TSEmphasis', s:palette.none, s:palette.none, 'italic')
call nightfall_dimmed#highlight('TSUnderline', s:palette.none, s:palette.none, 'underline')
call nightfall_dimmed#highlight('TSNote', s:palette.bg0, s:palette.green, 'bold')
call nightfall_dimmed#highlight('TSWarning', s:palette.bg0, s:palette.yellow, 'bold')
call nightfall_dimmed#highlight('TSDanger', s:palette.bg0, s:palette.red, 'bold')
...
call nightfall_dimmed#highlight('TSURI', s:palette.blue, s:palette.none, 'underline')
...
if has('nvim-0.8')
  ...
  highlight! link @string.special.symbol.elixir Blue
  highlight! link @constant.elixir Blue
endif
if has('nvim-0.9')
  ...
  call nightfall_dimmed#highlight('DiagnosticUnnecessary', s:palette.grey1, s:palette.none)
endif
...
" }}}
" neoclide/coc.nvim {{{
call nightfall_dimmed#highlight('CocHoverRange', s:palette.none, s:palette.none, 'bold,underline')
call nightfall_dimmed#highlight('CocSearch', s:palette.green, s:palette.none, 'bold')
call nightfall_dimmed#highlight('CocPumSearch', s:palette.green, s:palette.none, 'bold')
call nightfall_dimmed#highlight('CocMarkdownHeader', s:palette.orange, s:palette.none, 'bold')
call nightfall_dimmed#highlight('CocMarkdownLink', s:palette.green, s:palette.none, 'underline')
...
if !exists('g:Lf_StlColorscheme')
  let g:Lf_StlColorscheme = 'nightfall_dimmed'
endif
if !exists('g:Lf_PopupColorscheme')
  let g:Lf_PopupColorscheme = 'nightfall_dimmed'
endif
call nightfall_dimmed#highlight('Lf_hl_match', s:palette.green, s:palette.none, 'bold')
call nightfall_dimmed#highlight('Lf_hl_match0', s:palette.green, s:palette.none, 'bold')
call nightfall_dimmed#highlight('Lf_hl_match1', s:palette.aqua, s:palette.none, 'bold')
call nightfall_dimmed#highlight('Lf_hl_match2', s:palette.blue, s:palette.none, 'bold')
call nightfall_dimmed#highlight('Lf_hl_match3', s:palette.purple, s:palette.none, 'bold')
call nightfall_dimmed#highlight('Lf_hl_match4', s:palette.orange, s:palette.none, 'bold')
call nightfall_dimmed#highlight('Lf_hl_matchRefine', s:palette.red, s:palette.none, 'bold')
call nightfall_dimmed#highlight('Lf_hl_popup_normalMode', s:palette.bg0, s:palette.red, 'bold')
call nightfall_dimmed#highlight('Lf_hl_popup_inputMode', s:palette.bg0, s:palette.green, 'bold')
call nightfall_dimmed#highlight('Lf_hl_popup_category', s:palette.fg, s:palette.bg4)
call nightfall_dimmed#highlight('Lf_hl_popup_nameOnlyMode', s:palette.fg, s:palette.bg3)
call nightfall_dimmed#highlight('Lf_hl_popup_fullPathMode', s:palette.fg, s:palette.bg3)
call nightfall_dimmed#highlight('Lf_hl_popup_fuzzyMode', s:palette.fg, s:palette.bg3)
call nightfall_dimmed#highlight('Lf_hl_popup_regexMode', s:palette.fg, s:palette.bg3)
call nightfall_dimmed#highlight('Lf_hl_popup_lineInfo', s:palette.yellow, s:palette.bg4)
call nightfall_dimmed#highlight('Lf_hl_popup_total', s:palette.bg0, s:palette.orange)
call nightfall_dimmed#highlight('Lf_hl_popup_cursor', s:palette.bg0, s:palette.green)
...
" }}}
" liuchengxu/vim-clap {{{
call nightfall_dimmed#highlight('ClapSelected', s:palette.red, s:palette.none, 'bold')
call nightfall_dimmed#highlight('ClapCurrentSelection', s:palette.none, s:palette.bg1, 'bold')
call nightfall_dimmed#highlight('ClapSpinner', s:palette.orange, s:palette.bg2, 'bold')
call nightfall_dimmed#highlight('ClapBlines', s:palette.fg, s:palette.none)
call nightfall_dimmed#highlight('ClapProviderId', s:palette.fg, s:palette.none, 'bold')
call nightfall_dimmed#highlight('ClapMatches1', s:palette.red, s:palette.none, 'bold')
call nightfall_dimmed#highlight('ClapMatches2', s:palette.orange, s:palette.none, 'bold')
call nightfall_dimmed#highlight('ClapMatches3', s:palette.yellow, s:palette.none, 'bold')
call nightfall_dimmed#highlight('ClapMatches4', s:palette.aqua, s:palette.none, 'bold')
call nightfall_dimmed#highlight('ClapMatches5', s:palette.blue, s:palette.none, 'bold')
call nightfall_dimmed#highlight('ClapMatches6', s:palette.purple, s:palette.none, 'bold')
call nightfall_dimmed#highlight('ClapFuzzyMatches', s:palette.green, s:palette.none, 'bold')
call nightfall_dimmed#highlight('ClapNoMatchesFound', s:palette.red, s:palette.none, 'bold')
...
" }}}
" Shougo/denite.nvim {{{
call nightfall_dimmed#highlight('deniteMatchedChar', s:palette.green, s:palette.none, 'bold')
call nightfall_dimmed#highlight('deniteMatchedRange', s:palette.green, s:palette.none, 'bold,underline')
call nightfall_dimmed#highlight('deniteInput', s:palette.green, s:palette.bg3, 'bold')
call nightfall_dimmed#highlight('deniteStatusLineNumber', s:palette.purple, s:palette.bg3)
call nightfall_dimmed#highlight('deniteStatusLinePath', s:palette.fg, s:palette.bg3)
highlight! link deniteSelectedLin Green
" }}}
" kien/ctrlp.vim {{{
call nightfall_dimmed#highlight('CtrlPMatch', s:palette.green, s:palette.none, 'bold')
call nightfall_dimmed#highlight('CtrlPPrtBase', s:palette.bg3, s:palette.none)
call nightfall_dimmed#highlight('CtrlPLinePre', s:palette.bg3, s:palette.none)
call nightfall_dimmed#highlight('CtrlPMode1', s:palette.blue, s:palette.bg3, 'bold')
call nightfall_dimmed#highlight('CtrlPMode2', s:palette.bg0, s:palette.blue, 'bold')
call nightfall_dimmed#highlight('CtrlPStats', s:palette.grey1, s:palette.bg3, 'bold')
...
call nightfall_dimmed#highlight('MatchParenCur', s:palette.none, s:palette.none, 'bold')
call nightfall_dimmed#highlight('MatchWord', s:palette.none, s:palette.none, 'underline')
call nightfall_dimmed#highlight('MatchWordCur', s:palette.none, s:palette.none, 'underline')
" }}}
...
" }}}
" justinmk/vim-sneak {{{
call nightfall_dimmed#highlight('SneakLabelMask', s:palette.orange, s:palette.orange)
...
call nightfall_dimmed#highlight('VMCursor', s:palette.blue, s:palette.bg_blue)
...
if get(g:, 'indent_guides_auto_colors', 1) == 0
  call nightfall_dimmed#highlight('IndentGuidesOdd', s:palette.bg0, s:palette.bg1)
  call nightfall_dimmed#highlight('IndentGuidesEven', s:palette.bg0, s:palette.bg2)
endif
" }}}
...
call nightfall_dimmed#highlight('QuickScopePrimary', s:palette.aqua, s:palette.none, 'underline')
call nightfall_dimmed#highlight('QuickScopeSecondary', s:palette.blue, s:palette.none, 'underline')
" }}}
" APZelos/blamer.nvim {{{
...
if has('nvim')
" hrsh7th/nvim-cmp {{{
call nightfall_dimmed#highlight('CmpItemAbbrMatch', s:palette.green, s:palette.none, 'bold')
call nightfall_dimmed#highlight('CmpItemAbbrMatchFuzzy', s:palette.green, s:palette.none, 'bold')
...
for kind in g:nightfall_dimmed_lsp_kind_color
...
call nightfall_dimmed#highlight('HopNextKey1', s:palette.green, s:palette.none, 'bold')
highlight! link HopNextKey2 Green
highlight! link HopUnmatched Grey
" }}}
" lukas-reineke/indent-blankline.nvim {{{
call nightfall_dimmed#highlight('IblScope', s:palette.grey1, s:palette.none, 'nocombine')
call nightfall_dimmed#highlight('IblIndent', s:palette.bg4, s:palette.none, 'nocombine')
call nightfall_dimmed#highlight('IndentBlanklineContextStart', s:palette.none, s:palette.bg2)
...
" }}}
" romgrk/barbar.nvim {{{
call nightfall_dimmed#highlight('BufferCurrent', s:palette.fg, s:palette.bg0)
call nightfall_dimmed#highlight('BufferCurrentIndex', s:palette.fg, s:palette.bg0)
call nightfall_dimmed#highlight('BufferCurrentMod', s:palette.blue, s:palette.bg0)
call nightfall_dimmed#highlight('BufferCurrentSign', s:palette.statusline1, s:palette.bg0)
call nightfall_dimmed#highlight('BufferCurrentTarget', s:palette.red, s:palette.bg0, 'bold')
call nightfall_dimmed#highlight('BufferVisible', s:palette.fg, s:palette.bg_dim)
call nightfall_dimmed#highlight('BufferVisibleIndex', s:palette.fg, s:palette.bg_dim)
call nightfall_dimmed#highlight('BufferVisibleMod', s:palette.blue, s:palette.bg_dim)
call nightfall_dimmed#highlight('BufferVisibleSign', s:palette.statusline1, s:palette.bg_dim)
call nightfall_dimmed#highlight('BufferVisibleTarget', s:palette.yellow, s:palette.bg_dim, 'bold')
call nightfall_dimmed#highlight('BufferInactive', s:palette.grey1, s:palette.bg_dim)
call nightfall_dimmed#highlight('BufferInactiveIndex', s:palette.grey1, s:palette.bg_dim)
call nightfall_dimmed#highlight('BufferInactiveMod', s:palette.grey1, s:palette.bg_dim)
call nightfall_dimmed#highlight('BufferInactiveSign', s:palette.grey0, s:palette.bg_dim)
call nightfall_dimmed#highlight('BufferInactiveTarget', s:palette.yellow, s:palette.bg_dim, 'bold')
call nightfall_dimmed#highlight('BufferTabpages', s:palette.grey1, s:palette.bg_dim, 'bold')
call nightfall_dimmed#highlight('BufferTabpageFill', s:palette.bg_dim, s:palette.bg_dim)
" }}}
" rcarriga/nvim-notify {{{
call nightfall_dimmed#highlight('NotifyBackground', s:palette.none, s:palette.bg0)
...
call nightfall_dimmed#highlight('DapUIModifiedValue', s:palette.blue, s:palette.none, 'bold')
call nightfall_dimmed#highlight('DapUIBreakpointsCurrentLine', s:palette.blue, s:palette.none, 'bold')
...
call nightfall_dimmed#highlight('LspFloatWinBorder', s:palette.bg0, s:palette.bg0)
call nightfall_dimmed#highlight('LspSagaDiagnosticHeader', s:palette.orange, s:palette.none, 'bold')
call nightfall_dimmed#highlight('LspSagaCodeActionTitle', s:palette.purple, s:palette.none, 'bold')
call nightfall_dimmed#highlight('DefinitionPreviewTitle', s:palette.blue, s:palette.none, 'bold')
...
" }}}
" b0o/incline.nvim {{{
call nightfall_dimmed#highlight('InclineNormalNC', s:palette.grey1, s:palette.bg2)
" }}}
" echasnovski/mini.nvim {{{
call nightfall_dimmed#highlight('MiniAnimateCursor', s:palette.none, s:palette.none, 'reverse,nocombine')
if s:configuration.float_style ==# 'dim'
  call nightfall_dimmed#highlight('MiniFilesTitleFocused', s:palette.green, s:palette.bg_dim, 'bold')
else
  call nightfall_dimmed#highlight('MiniFilesTitleFocused', s:palette.green, s:palette.bg2, 'bold')
endif
call nightfall_dimmed#highlight('MiniHipatternsFixme', s:palette.bg0, s:palette.red, 'bold')
call nightfall_dimmed#highlight('MiniHipatternsHack', s:palette.bg0, s:palette.yellow, 'bold')
call nightfall_dimmed#highlight('MiniHipatternsNote', s:palette.bg0, s:palette.blue, 'bold')
call nightfall_dimmed#highlight('MiniHipatternsTodo', s:palette.bg0, s:palette.green, 'bold')
call nightfall_dimmed#highlight('MiniIconsAzure', s:palette.blue, s:palette.none)
call nightfall_dimmed#highlight('MiniIconsBlue', s:palette.blue, s:palette.none)
call nightfall_dimmed#highlight('MiniIconsCyan', s:palette.aqua, s:palette.none)
call nightfall_dimmed#highlight('MiniIconsGreen', s:palette.green, s:palette.none)
call nightfall_dimmed#highlight('MiniIconsGrey', s:palette.grey2, s:palette.none)
call nightfall_dimmed#highlight('MiniIconsOrange', s:palette.orange, s:palette.none)
call nightfall_dimmed#highlight('MiniIconsPurple', s:palette.purple, s:palette.none)
call nightfall_dimmed#highlight('MiniIconsRed', s:palette.red, s:palette.none)
call nightfall_dimmed#highlight('MiniIconsYellow', s:palette.yellow, s:palette.none)
call nightfall_dimmed#highlight('MiniIndentscopePrefix', s:palette.none, s:palette.none, 'nocombine')
call nightfall_dimmed#highlight('MiniJump2dSpot', s:palette.orange, s:palette.none, 'bold,nocombine')
call nightfall_dimmed#highlight('MiniJump2dSpotAhead', s:palette.aqua, s:palette.none, 'nocombine')
call nightfall_dimmed#highlight('MiniJump2dSpotUnique', s:palette.yellow, s:palette.none, 'bold,nocombine')
call nightfall_dimmed#highlight('MiniStarterCurrent', s:palette.none, s:palette.none, 'nocombine')
call nightfall_dimmed#highlight('MiniStatuslineDevinfo', s:palette.grey1, s:palette.bg1)
call nightfall_dimmed#highlight('MiniStatuslineFileinfo', s:palette.grey1, s:palette.bg1)
call nightfall_dimmed#highlight('MiniStatuslineModeCommand', s:palette.bg0, s:palette.aqua, 'bold')
call nightfall_dimmed#highlight('MiniStatuslineModeInsert', s:palette.bg0, s:palette.statusline2, 'bold')
call nightfall_dimmed#highlight('MiniStatuslineModeNormal', s:palette.bg0, s:palette.statusline1, 'bold')
call nightfall_dimmed#highlight('MiniStatuslineModeOther', s:palette.bg0, s:palette.purple, 'bold')
call nightfall_dimmed#highlight('MiniStatuslineModeReplace', s:palette.bg0, s:palette.orange, 'bold')
call nightfall_dimmed#highlight('MiniStatuslineModeVisual', s:palette.bg0, s:palette.statusline3, 'bold')
call nightfall_dimmed#highlight('MiniTablineCurrent', s:palette.fg, s:palette.bg4)
call nightfall_dimmed#highlight('MiniTablineHidden', s:palette.grey1, s:palette.bg2)
call nightfall_dimmed#highlight('MiniTablineModifiedCurrent', s:palette.blue, s:palette.bg4)
call nightfall_dimmed#highlight('MiniTablineModifiedHidden', s:palette.grey1, s:palette.bg2)
call nightfall_dimmed#highlight('MiniTablineModifiedVisible', s:palette.blue, s:palette.bg2)
call nightfall_dimmed#highlight('MiniTablineTabpagesection', s:palette.bg0, s:palette.statusline1, 'bold')
call nightfall_dimmed#highlight('MiniTablineVisible', s:palette.fg, s:palette.bg2)
call nightfall_dimmed#highlight('MiniTestEmphasis', s:palette.none, s:palette.none, 'bold')
call nightfall_dimmed#highlight('MiniTestFail', s:palette.red, s:palette.none, 'bold')
call nightfall_dimmed#highlight('MiniTestPass', s:palette.green, s:palette.none, 'bold')
call nightfall_dimmed#highlight('MiniTrailspace', s:palette.none, s:palette.red)
...
call nightfall_dimmed#highlight('LightspeedLabel', s:palette.red, s:palette.none, 'bold,underline')
call nightfall_dimmed#highlight('LightspeedLabelDistant', s:palette.blue, s:palette.none, 'bold,underline')
call nightfall_dimmed#highlight('LightspeedShortcut', s:palette.bg0, s:palette.red, 'bold')
call nightfall_dimmed#highlight('LightspeedUnlabeledMatch', s:palette.fg, s:palette.none, 'bold')
call nightfall_dimmed#highlight('LightspeedPendingOpArea', s:palette.bg0, s:palette.green)
...
" For example, the content between `syn_begin: sh/zsh` and `syn_end` will be placed in `after/syntax/sh/nightfall_dimmed.vim` and `after/syntax/zsh/nightfall_dimmed.vim`.
if nightfall_dimmed#syn_exists(s:path) " If the syntax files exist.
  if s:configuration.better_performance
    if !nightfall_dimmed#syn_newest(s:path, s:last_modified) " Regenerate if it's not up to date.
      call nightfall_dimmed#syn_clean(s:path, 0)
      call nightfall_dimmed#syn_gen(s:path, s:last_modified, 'update')
    endif
    finish
  else
    call nightfall_dimmed#syn_clean(s:path, 1)
  endif
else
  if s:configuration.better_performance
    call nightfall_dimmed#syn_gen(s:path, s:last_modified, 'generate')
    finish
  endif
endif
" syn_begin: vim-plug {{{
" https://github.com/junegunn/vim-plug
call nightfall_dimmed#highlight('plug1', s:palette.orange, s:palette.none, 'bold')
call nightfall_dimmed#highlight('plugNumber', s:palette.yellow, s:palette.none, 'bold')
...
if !s:configuration.transparent_background
  call nightfall_dimmed#highlight('NvimTreeNormal', s:palette.fg, s:palette.bg_dim)
  call nightfall_dimmed#highlight('NvimTreeEndOfBuffer', s:palette.bg_dim, s:palette.bg_dim)
  call nightfall_dimmed#highlight('NvimTreeVertSplit', s:palette.bg0, s:palette.bg0)
  call nightfall_dimmed#highlight('NvimTreeCursorLine', s:palette.none, s:palette.bg0)
endif
...
if !s:configuration.transparent_background
  call nightfall_dimmed#highlight('NeoTreeNormal', s:palette.fg, s:palette.bg_dim)
  call nightfall_dimmed#highlight('NeoTreeEndOfBuffer', s:palette.bg_dim, s:palette.bg_dim)
  call nightfall_dimmed#highlight('NeoTreeVertSplit', s:palette.bg0, s:palette.bg0)
endif
...
call nightfall_dimmed#highlight('OctoViewer', s:palette.bg0, s:palette.blue)
call nightfall_dimmed#highlight('OctoGreenFloat', s:palette.green, s:palette.bg2)
call nightfall_dimmed#highlight('OctoRedFloat', s:palette.red, s:palette.bg2)
call nightfall_dimmed#highlight('OctoPurpleFloat', s:palette.purple, s:palette.bg2)
call nightfall_dimmed#highlight('OctoYellowFloat', s:palette.yellow, s:palette.bg2)
call nightfall_dimmed#highlight('OctoBlueFloat', s:palette.blue, s:palette.bg2)
call nightfall_dimmed#highlight('OctoGreyFloat', s:palette.grey1, s:palette.bg2)
call nightfall_dimmed#highlight('OctoBubbleGreen', s:palette.bg0, s:palette.green)
call nightfall_dimmed#highlight('OctoBubbleRed', s:palette.bg0, s:palette.red)
call nightfall_dimmed#highlight('OctoBubblePurple', s:palette.bg0, s:palette.purple)
call nightfall_dimmed#highlight('OctoBubbleYellow', s:palette.bg0, s:palette.yellow)
call nightfall_dimmed#highlight('OctoBubbleBlue', s:palette.bg0, s:palette.blue)
call nightfall_dimmed#highlight('OctoBubbleGrey', s:palette.bg0, s:palette.grey1)
...
call nightfall_dimmed#highlight('UndotreeSavedBig', s:palette.purple, s:palette.none, 'bold')
...
" syn_begin: markdown {{{
" builtin: {{{
call nightfall_dimmed#highlight('markdownH1', s:palette.red, s:palette.none, 'bold')
call nightfall_dimmed#highlight('markdownH2', s:palette.orange, s:palette.none, 'bold')
call nightfall_dimmed#highlight('markdownH3', s:palette.yellow, s:palette.none, 'bold')
call nightfall_dimmed#highlight('markdownH4', s:palette.green, s:palette.none, 'bold')
call nightfall_dimmed#highlight('markdownH5', s:palette.blue, s:palette.none, 'bold')
call nightfall_dimmed#highlight('markdownH6', s:palette.purple, s:palette.none, 'bold')
call nightfall_dimmed#highlight('markdownItalic', s:palette.none, s:palette.none, 'italic')
call nightfall_dimmed#highlight('markdownBold', s:palette.none, s:palette.none, 'bold')
call nightfall_dimmed#highlight('markdownItalicDelimiter', s:palette.grey1, s:palette.none, 'italic')
...
call nightfall_dimmed#highlight('mkdURL', s:palette.blue, s:palette.none, 'underline')
call nightfall_dimmed#highlight('mkdInlineURL', s:palette.purple, s:palette.none, 'underline')
call nightfall_dimmed#highlight('mkdItalic', s:palette.grey1, s:palette.none, 'italic')
...
if has('nvim-0.8')
  ...
  if !has('nvim-0.10')
    call nightfall_dimmed#highlight('@markup.italic', s:palette.none, s:palette.none, 'italic')
    call nightfall_dimmed#highlight('@markup.strikethrough', s:palette.none, s:palette.none, 'strikethrough')
  endif
endif
" }}}
" syn_end }}}
" syn_begin: vimwiki {{{
call nightfall_dimmed#highlight('VimwikiHeader1', s:palette.red, s:palette.none, 'bold')
call nightfall_dimmed#highlight('VimwikiHeader2', s:palette.orange, s:palette.none, 'bold')
call nightfall_dimmed#highlight('VimwikiHeader3', s:palette.yellow, s:palette.none, 'bold')
call nightfall_dimmed#highlight('VimwikiHeader4', s:palette.green, s:palette.none, 'bold')
call nightfall_dimmed#highlight('VimwikiHeader5', s:palette.blue, s:palette.none, 'bold')
call nightfall_dimmed#highlight('VimwikiHeader6', s:palette.purple, s:palette.none, 'bold')
call nightfall_dimmed#highlight('VimwikiLink', s:palette.blue, s:palette.none, 'underline')
call nightfall_dimmed#highlight('VimwikiItalic', s:palette.none, s:palette.none, 'italic')
call nightfall_dimmed#highlight('VimwikiBold', s:palette.none, s:palette.none, 'bold')
call nightfall_dimmed#highlight('VimwikiUnderline', s:palette.none, s:palette.none, 'underline')
...
call nightfall_dimmed#highlight('rstStandaloneHyperlink', s:palette.purple, s:palette.none, 'underline')
...
call nightfall_dimmed#highlight('htmlH1', s:palette.red, s:palette.none, 'bold')
call nightfall_dimmed#highlight('htmlH2', s:palette.orange, s:palette.none, 'bold')
call nightfall_dimmed#highlight('htmlH3', s:palette.yellow, s:palette.none, 'bold')
call nightfall_dimmed#highlight('htmlH4', s:palette.green, s:palette.none, 'bold')
call nightfall_dimmed#highlight('htmlH5', s:palette.blue, s:palette.none, 'bold')
call nightfall_dimmed#highlight('htmlH6', s:palette.purple, s:palette.none, 'bold')
call nightfall_dimmed#highlight('htmlLink', s:palette.none, s:palette.none, 'underline')
call nightfall_dimmed#highlight('htmlBold', s:palette.none, s:palette.none, 'bold')
call nightfall_dimmed#highlight('htmlBoldUnderline', s:palette.none, s:palette.none, 'bold,underline')
call nightfall_dimmed#highlight('htmlBoldItalic', s:palette.none, s:palette.none, 'bold,italic')
call nightfall_dimmed#highlight('htmlBoldUnderlineItalic', s:palette.none, s:palette.none, 'bold,underline,italic')
call nightfall_dimmed#highlight('htmlUnderline', s:palette.none, s:palette.none, 'underline')
call nightfall_dimmed#highlight('htmlUnderlineItalic', s:palette.none, s:palette.none, 'underline,italic')
call nightfall_dimmed#highlight('htmlItalic', s:palette.none, s:palette.none, 'italic')
...
call nightfall_dimmed#highlight('semshiUnresolved', s:palette.yellow, s:palette.none, 'undercurl')
...
" syn_end }}}
" syn_begin: vim {{{
call nightfall_dimmed#highlight('vimCommentTitle', s:palette.grey1, s:palette.none, 'bold')
...
call nightfall_dimmed#highlight('tomlTable', s:palette.orange, s:palette.none, 'bold')
...
" syn_end }}}
" syn_begin: dosini {{{
call nightfall_dimmed#highlight('dosiniHeader', s:palette.red, s:palette.none, 'bold')
highlight! link dosiniLabel Yellow
highlight! link dosiniValue Green
highlight! link dosiniNumber Green
" syn_end }}}
" syn_begin: help {{{
call nightfall_dimmed#highlight('helpNote', s:palette.purple, s:palette.none, 'bold')
call nightfall_dimmed#highlight('helpHeadline', s:palette.red, s:palette.none, 'bold')
call nightfall_dimmed#highlight('helpHeader', s:palette.orange, s:palette.none, 'bold')
call nightfall_dimmed#highlight('helpURL', s:palette.green, s:palette.none, 'underline')
call nightfall_dimmed#highlight('helpHyperTextEntry', s:palette.yellow, s:palette.none, 'bold')
...
call nightfall_dimmed#highlight('NeotestExpandMarker', s:palette.bg5, s:palette.none)
...
call nightfall_dimmed#highlight('MasonHeader', s:palette.bg0, s:palette.green, 'bold')
call nightfall_dimmed#highlight('MasonHeaderSecondary', s:palette.bg0, s:palette.orange, 'bold')
highlight! link MasonHighlight Green
highlight! link MasonHighlightSecondary Yellow
call nightfall_dimmed#highlight('MasonHighlightBlock', s:palette.bg0, s:palette.aqua)
call nightfall_dimmed#highlight('MasonHighlightBlockBold', s:palette.bg0, s:palette.aqua, 'bold')
call nightfall_dimmed#highlight('MasonHighlightBlockSecondary', s:palette.bg0, s:palette.yellow)
call nightfall_dimmed#highlight('MasonHighlightBlockBoldSecondary', s:palette.bg0, s:palette.yellow, 'bold')
call nightfall_dimmed#highlight('MasonMuted', s:palette.grey0, s:palette.none)
